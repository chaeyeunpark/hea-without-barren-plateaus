...
with open("kicked_ising_mbl/_version.py") as f:
...
info = {
    ...
    "url": "https://github.com/chaeyeunpark/kicked-ising-mbl",
    ...
    "provides": ["kicked_ising_mbl"],
    "install_requires": requirements,
    "ext_modules": [CMakeExtension("kicked_ising_mbl")],
    "cmdclass": {"build_ext": CMakeBuild},
    "ext_package": "kicked_ising_mbl"
}
